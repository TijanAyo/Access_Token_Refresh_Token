...
const refresh_token_1 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImlhdCI6MTY3NjcxMDY4NiwiZXhwIjoxNjc5MzAyNjg2fQ.7xcFqZ81bvMBwCjnTE8Du8TcqfPdkyhALkpug4GE1g0"
...
app.post('/refresh', (req, res) => {
    ...
    jwt.verify(refreshToken, secret, (err, decoded) => {
      ...
      const refreshTokens = [
        { id: 1, refreshToken: refresh_token_1, expiry: Date.now() + 30 * 24 * 60 * 60 * 1000 },
        { id: 2, refreshToken: 'refresh_token_2', expiry: Date.now() + 30 * 24 * 60 * 60 * 1000 },
      ];
